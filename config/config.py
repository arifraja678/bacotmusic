...
API_ID = int(getenv("API_ID", "24121327"))
API_HASH = getenv("API_HASH", "131d930b965a92df0fcb5eff814314d3")

## Get it from @Botfather in Telegram.
BOT_TOKEN = getenv("BOT_TOKEN", "7937100734:AAEna05rXhXBWhBBMzr-jeO6xOHBCfkZb38")
...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/midharma/extra.git",
)
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "5825513460").split())
...
SERVER_PLAYLIST_LIMIT = int(getenv("SERVER_PLAYLIST_LIMIT", "99999"))

# MaximuM limit for fetching playlist's track from youtube, spotify, apple links.
PLAYLIST_FETCH_LIMIT = int(getenv("PLAYLIST_FETCH_LIMIT", "99999"))
...
STRING1 = getenv("STRING_SESSION", "BQDXqWQATL15BfsFhEYwTnbKh2x9Rq7OddYijzAvQkkRK6jl1gxzrFfMjCtdwVwcum8oXUrxt6aAe0ngpIvoB7O3jBUuZOvCcSUzL9zyj5UynQpXtYix88z6-r1n3tYGmnQXpGM0Gk3gyeIEkP_m7oBxtDuXvBnekhfhcV6uYSHpSw9CWm29ruBBHCj7i7YaCwIhYKRZKrLBxBuU-UtRLjivxeqagYlAdw2THKdj5umK0wUde6cuCkRJcx8ksEy3MEVOV4Yk0UiPK1ybe5Vh4itAeo5i-LQkj8_0UuakQ14zM1DZAhrFoVFEHYuYnIyQBwP-2mv6M0PiJ5tIx30J6dFt_x38eQAAAAGo350gAA")
...
YTDOWNLOADER = 1
LOG = 2
LOG_FILE_NAME = "bacotrobottlogs.txt"
adminlist = {}
lyrical = {}
chatstats = {}
userstats = {}
